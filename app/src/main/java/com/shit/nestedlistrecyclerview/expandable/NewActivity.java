package com.shit.nestedlistrecyclerview.expandable;
...
import com.shit.nestedlistrecyclerview.MainActivity;
...
public class NewActivity extends AppCompatActivity {
    ...
    private OnItemClickListener mOnItemClickListener = new OnItemClickListener() {
        ...
        private void showItemDescription(Object object, ItemInfo itemInfo) {
            ...
            Toast.makeText(NewActivity.this, builder.toString(), Toast.LENGTH_SHORT).show();
        }
    ...
    private class ListAdapter extends MultiLevelListAdapter {
        ...
        public View getViewForObject(Object object, View convertView, ItemInfo itemInfo) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(NewActivity.this).inflate(R.layout.data_item, null);
